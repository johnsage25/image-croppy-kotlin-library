...
import com.pearldrift.croppylib.cropview.AspectMode.*
import com.pearldrift.croppylib.util.model.Corner.*
import com.pearldrift.croppylib.util.model.Corner.NONE
import com.pearldrift.croppylib.util.model.DraggingState.DraggingCorner
import com.pearldrift.croppylib.util.model.DraggingState.DraggingEdge
...
import com.pearldrift.aspectratiorecyclerviewlib.aspectratio.model.AspectRatio.*
import com.pearldrift.croppylib.ui.CroppedBitmapData
import com.pearldrift.croppylib.main.CroppyTheme
import com.pearldrift.croppylib.util.extensions.*
import com.pearldrift.croppylib.util.model.*
        ...
        when (aspectAspectMode) {
            FREE -> {
                when (val state = draggingState) {
                    ...
                    DraggingState.DraggingBitmap -> TODO()
                    DraggingState.Idle -> TODO()
                }
            }
            ASPECT -> {
